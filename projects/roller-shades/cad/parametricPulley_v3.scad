...
retainer_height_p = 0.5; // [0.5:Tiny (0.5mm), 1:Small (1mm), 1.5:Normal (1.5mm), 2:Big (2mm), 3:Bigger (3mm), 4:Hudge (5mm)]
belt_idler = 0; // [0:No, 1:Yes]
// Height of idler flange over pulley. Set to same as base height if you want an idler but no pulley.
idler_height_p = 0.5; // [0.5:Tiny (0.5mm), 1:Small (1mm), 1.5:Normal (1.5mm), 2:Big (2mm), 3:Bigger (3mm), 4:Hudge (5mm)]
...
if ( profile == 12 ){projection() pulley("GT2 2mm" , GT2_2mm_pulley_dia , 0.764 , 1.494 ); }
